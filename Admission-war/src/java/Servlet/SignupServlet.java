...
public class SignupServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            out.println("<li><a href=\"listaSpecializari.html\" target=\"_blank\">Listă specializări</a></li>");
            ...
            out.println("</ul>");
            out.println("</li>");
            out.println("<li><a href=\"detaliiCont.html\" target=\"_blank\">Contul meu</a></li>");
            out.println("</ul>");
            out.println("</div>");
